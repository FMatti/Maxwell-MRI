...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \draw[ultra thick] (6, 2) to (0, 2) to (0, 0) to (6, 0);
    \end{tikzpicture}
    \caption{Waveguide}
    \label{fig:waveguide}
\end{figure}
...
\begin{equation}
    \mathbf{g} = \mu^{-1} \mathbf{B} \times \mathbf{n} = \mu^{-1} B_0 (\mathbf{e}_y \times \mathbf{e}_x) = -\mu^{-1} B_0 \mathbf{e}_z
\end{equation}
