...
\begin{frame}{Finite element method | Weak formulation}
    ...
    \onslide<1->{
    \begin{equation*}
        H_{\text{curl}}(\Omega) = \{ \mathbf{v}: \Omega \to \mathbb{C}^3,~\text{such that}~\mathbf{v} \in L_2(\Omega),~\nabla \times \mathbf{v} \in L_2(\Omega) \}
    \end{equation*}
    }%
...
\begin{frame}{Finite element method | Computational domain}
    \begin{figure}
        \centering
        {\input{../report/figures/2d_cavity.tex}}
    \end{figure}
\end{frame}
...
\begin{frame}{Finite element method | Finite element space}
    \onslide<1->{
        ...
        \begin{equation}
            \mathbf{u}_h(\omega) = \sum_{i=1}^{N_h} u_i(\omega) \boldsymbol{\phi}_i
        \end{equation}
        for a basis $\{ \boldsymbol{\phi}_i \}_{i=1}^{N_h}$ of a finite dimensional
        ...
        and the norm 
        \begin{equation*}
           || \mathbf{\bar{u}} ||_M = \sqrt{\langle \mathbf{\bar{u}}, \mathbf{\bar{u}} \rangle_M}
        \end{equation*}
    }
