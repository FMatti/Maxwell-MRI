...
\begin{frame}{Finite element method | Boundary conditions}
    ...
    \onslide<1->{
        ...
        \begin{equation*}
            \mathbf{u} \times \mathbf{n} = \mathbf{0},~\text{on}~\Gamma_D
        \end{equation*}
    }\onslide<2->{
        ...
        \fill[white] (-7.5, -1) rectangle (7.5, 3);
...
\begin{frame}{Minimal rational interpolation | Surrogate}
    ...
    \onslide<1->{
        Rational surrogate
        \begin{equation*}
            \mathbf{\tilde{u}}(\omega) = \frac{\mathbf{P}(\omega)}{Q(\omega)} = \sum_{i=1}^S \frac{\mathbf{p}_i}{\omega - \omega_i} / \sum_{i=1}^S \frac{q_i}{\omega - \omega_i}
        \end{equation*}
...
\begin{frame}{Minimal rational interpolation | Tweak 2}
    ...
    \onslide<2->{
        Can recover the original surrogate
        \begin{equation*}
