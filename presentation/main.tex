...
\begin{frame}{Rectangular cavity | Error progression}
    \begin{figure}
        \centering
        \scalebox{0.8}{\input{../report/plots/rectangular_cavity_errorprogression.pgf}}
    \end{figure}
\end{frame}
...
%    \begin{figure}
%        \centering
%        \scalebox{0.8}{\input{../report/plots/imperfect_conductor_solution.pdf}}
%    \end{figure}
%\end{frame}
...
\begin{frame}{DMCWF | Error progression}
    \begin{figure}
        \centering
        \scalebox{0.8}{\input{../report/plots/circular_waveguide_error.pgf}}
    \end{figure}
\end{frame}
