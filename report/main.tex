...
and norms with $||\cdot||$. For simplicity, results are delivered without units
...
\end{equation}
% REMINDME! vvv Correct definiton of H1-space?
...
% REMINDME! Discuss better conditioning for going route via QR-decompostition
% instead of Gramian matrix.
